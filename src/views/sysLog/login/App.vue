<template>
  <div v-loading="loading" class="ofa-container column">
    <div class="header">
      <div class="title-box">
        <span class="title ofa-text-title">登录日志<span class="sub-title" style="margin-left: 10px;">共有<label
      ...
      <div class="search-box">
        ...
        <el-input v-model="searchOption.key" size="small" placeholder="账号"></el-input>
    ...
    <el-table :data="list" size="small" class="ofa-table">
      <el-table-column prop="UserName" label="登录账号" min-width="200"></el-table-column>
      <el-table-column prop="CreatorName" label="昵称" min-width="200"></el-table-column>
      <el-table-column prop="Source" label="来源" min-width="200"></el-table-column>
      <el-table-column prop="LoginType" label="登录方式" min-width="200"></el-table-column>
      <el-table-column prop="IPAddress" label="Ip地址" width="200"></el-table-column>
      <el-table-column prop="CreateTime" label="登录时间" width="160"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    get () {
      const url = this.$root.getApi(API.KEY, API.LOGIN_LOG.URL)
    ...
    toFormPage (params) {
      this.$root.navigate({ ...LOGIN_LOG_FORM, params: params })
    }
  },
  created () {
    this.init()
